...
PKI_TRUSTPASS=${PWD_TRUSTSTORE}
PKI_PASS=${PWD_KEYSTORE}
...
curl -sf --cacert ${PKI_CONFIG_DIR}/ca.crt --cert ${PKI_CONFIG_DIR}/client.p12:${PKI_PASS} "${DSH_KAFKA_CONFIG_ENDPOINT}/kafka/config/${KAFKA_GROUP}/${MESOS_TASK_ID}?format=json" > ${PKI_CONFIG_DIR}/datastreams.json
...
# echo "full datastreams_shell.properties file:"
# cat ${PKI_CONFIG_DIR}/datastreams_java.properties

echo "full properties.json file:"
cat ${PKI_CONFIG_DIR}/datastreams.json